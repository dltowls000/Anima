    ...
    public void SpawnAlly()
    {
        ...
        if (allyobjPrefab != null)
        {
            for(int i =0; i< allyobjPrefab.Count; i++)
            {
                ...
                allyinstance.Add(Instantiate(allyobjPrefab[i], new Vector3(-5.7f, 0.75f, 0f), Quaternion.identity));
                allyinstance[i].transform.localScale = new Vector3(0.7f,0.7f,0.7f);
